...
console.log("classrooms availability should be set to false: ", sysManager.data()[4][1]);
...
console.log("classrooms availability should be set to true again: ", sysManager.data()[4][1]);
